...
namespace SubscriptionTracker.Models
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Plan>().HasData(new Plan { PlanId = 1, Name = "Monthly", Cost = 1200, DurationMonths = 1 });
            modelBuilder.Entity<Plan>().HasData(new Plan { PlanId = 2, Name = "Quartely", Cost = 1200, DurationMonths = 3 });
            modelBuilder.Entity<Plan>().HasData(new Plan { PlanId = 3, Name = "Half-Yearly", Cost = 1200, DurationMonths = 6 });
            modelBuilder.Entity<Plan>().HasData(new Plan { PlanId = 4, Name = "Annualy", Cost = 1200, DurationMonths = 12 });
