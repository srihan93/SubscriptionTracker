...
namespace SubscriptionTracker.Models
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Plan>().HasData(new Plan { PlanId = 2, Name = "Quartely", Cost = 2800, DurationMonths = 3 });
            modelBuilder.Entity<Plan>().HasData(new Plan { PlanId = 3, Name = "Half-Yearly", Cost = 4000, DurationMonths = 6 });
            modelBuilder.Entity<Plan>().HasData(new Plan { PlanId = 4, Name = "Annualy", Cost = 6500, DurationMonths = 12 });
